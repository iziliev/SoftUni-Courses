namespace Robots.Tests
{
    ...
    public class RobotsTests
    {
        ...
        {
            var robot = new Robot("Ivo",15);
            Assert.AreEqual("Ivo", robot.Name);
            Assert.AreEqual(15, robot.Battery);
            Assert.AreEqual(15, robot.MaximumBattery);
        }

        [Test]
        public void ConstructorShouldSetCapacity5()
        {
        ...
        public void AddShouldThrowAnExceptionForRobotsWithTheSameName()
        {
            var robots = new RobotManager(100);
            robots.Add(new Robot("r1", 100));
            Assert.Throws<InvalidOperationException>(() => robots.Add(new Robot("r1", 1000)));
        }
        ...
        public void AddShouldThrowAnExceptionWhenCapacityIsReached()
        {
            ...
            robots.Add(new Robot("r1", 100));
            robots.Add(new Robot("r2", 100));
            Assert.Throws<InvalidOperationException>(() => robots.Add(new Robot("r3", 1000)));
        }
        ...
        public void WorkShouldThrowAnExceptionWhenRobotIsNotFound()
        {
            var robots = new RobotManager(2);
            robots.Add(new Robot("r1", 100));
            Assert.Throws<InvalidOperationException>(() => robots.Work("r2", "...", 20));
        }
        ...
        public void WorkShouldThrowAnExceptionWhenRobotIsExhausted()
        {
            ...
            Assert.Throws<InvalidOperationException>(() => robots.Work("r1", "...", 30));
        }
        ...
        public void ChargeShouldThrowAnExceptionWhenRobotIsNotFound()
        {
            var robots = new RobotManager(2);
            robots.Add(new Robot("r1", 100));
            Assert.Throws<InvalidOperationException>(() => robots.Charge("fsfsdfssfd"));
        }
    }
}
