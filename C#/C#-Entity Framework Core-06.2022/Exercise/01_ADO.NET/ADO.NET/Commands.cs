...
namespace ADO.Net
{
    ...
    {
        //Problem 01
        public static string createDB = @"CREATE DATABASE [MinionsDB]";

        public static string cteateTable = @"CREATE TABLE [Countries]
                                           (
        ...
        public static string insertValues = @"INSERT INTO [Countries]([Name]) 
                                                VALUES ('Bulgaria')
                                                       ,('England')
                                                       ,('Cyprus')
                                                       ,('Germany')
        ...
        //Problem 07
        public static string searchMinionsName = @"SELECT [Name] FROM [Minions]";
        ...
        public static string selectMinionByCondition = @"SELECT [Name], [Age] FROM [Minions] WHERE [Id] = @Id";
