...
namespace SoftUni.Data
{
    public partial class SoftUniContext : DbContext
    {
        ...
        public virtual DbSet<EmployeeAverageSalaries> EmployeesAverageSalaries { get; set; }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=.; Database=SoftUni;User Id=sa;Password=Ilievi84;Encrypt=false;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EmployeeAverageSalaries>(entity =>
            {
                entity.HasNoKey();
